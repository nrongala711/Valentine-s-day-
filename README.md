...
<body>
    ...
    <script>
        ...
        function moveNoButton() {
            ...
            // Make the No button say funny things
        ...
        function handleYesClick() {
            document.getElementById('question').innerHTML = "Yay! Happy Valentine’s Day to my forever Valentine. I’m so lucky to have you by my side today, and I can’t wait for all the years to come! 😘";
            document.querySelector('.buttons').style.display = 'none';
            document.getElementById('displayGif').src = "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExOHpueGZic3BqZzR3eGZic3BqZzR3eGZic3BqZzR3eGZic3BqZzR3JnB0X3NpZD1mcmVzaF9nZW5lcmF0aW9uJmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1n/MDJ9IbxxvDUQM/giphy.gif";
        }
    </script>
</body>
</html>
